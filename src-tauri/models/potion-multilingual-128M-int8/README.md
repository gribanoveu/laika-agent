...
license: mit
model_name: potion-multilingual-128M-int8
tags:
- embeddings
- static-embeddings
...
model = StaticModel.from_pretrained("potion-multilingual-128M-int8")
...
model = SentenceTransformer("potion-multilingual-128M-int8")
